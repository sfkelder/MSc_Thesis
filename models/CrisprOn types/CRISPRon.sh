...
$BINDIR/DeepCRISPRon_eval.py $OUTDIR $OUTDIR/21mers.fa $OUTDIR/CRISPRparams.tsv $OUTDIR/folding.txt /content/MSc_Thesis/models/4.model.best/  2>&1 | grep -v tracing
