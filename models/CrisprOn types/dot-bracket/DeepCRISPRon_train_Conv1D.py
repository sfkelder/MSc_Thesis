...
def preprocess_seq(data):
    ...
    DATA_F = np.zeros((len(dkeys), 100,3), dtype=np.float32) 
...
#folding
if TYPE.find('F') > -1:
    input_f = Input(shape=(100,3), name="input_folding")
...
if TYPE.find('F') > -1:
    conv1_out_f = Conv1D(100, 3, activation='relu', input_shape=(100,3,), name="conv_3_folding")(input_f)
...
#second convolution layer
    conv2_out_f = Conv1D(70, 5, activation='relu', input_shape=(100,3,), name="conv_5_folding")(input_f)
...
#third convolution layer
    conv3_out_f = Conv1D(40, 7, activation='relu', input_shape=(100,3,), name="conv_7_folding")(input_f)
