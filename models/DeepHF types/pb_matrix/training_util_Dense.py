...
def lstm_model(model_type='esp', batch_size=90, epochs=50, initializer='0',em_dim=44,em_drop=0.2,
    ...
    #folding feature
    folding_input = Input(name = 'folding_input', shape = (4850,))

    #x = keras.layers.concatenate([x, biological_input, folding_input ])
    x = keras.layers.concatenate([x, folding_input]) 
